...
public class AllTests {
    ...
    public static void main(String[] args) {
        new DiceImplTest ().rollTestForRange ();
        new GameTest ().playGameTestEqualDiceRoll ();
        new DiceImplTest ().rollTestIsRealRandom ();
        new GameTest ().playGameTestRightEqualFunction ();
    }
